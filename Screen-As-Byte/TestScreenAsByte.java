public class TestScreenAsBytes {
    ...
    public static void main(String[] args) {
...

        {
            ...
            ScreenAsBytes.setPixel(screen, 3, 2, 0); // set the third pixel on row 0 to 1
...

        {
            ...
            byte[] screen = new byte[6]; // a screen 16 pixels wide and 3 pixels tall, all set to 0 by default, i.e. black
            ScreenAsBytes.drawHorizontalLine(screen, 3, 1, 14, 1); // draw a line from pixels 1 to 14 (inclusive) on row 1
...

        {
            ...
            byte[] screen = new byte[6]; // a screen 16 pixels wide and 3 pixels tall, all set to 0 by default, i.e. black
            ScreenAsBytes.drawVerticalLine(screen, 3, 3, 0, 1); // draw a vertical line from pixel (3,0) to pixel (3,1)
