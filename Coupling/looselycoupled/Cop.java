...
public class Cop {
    ...
    private EvidenceBox evidencebox;
    ...
    public void takes(EvidenceBox box) {
        this.evidencebox = box;
        collectionOfEvidenceBoxes.add(box);
    }

    // method for checking if a certain evidence is in a specific box
    /**
     * This is a method that allows a policeman to check whether a certain evidence exists in a specific box - it will call another method in evidencebox class.
    ...
    public ArrayList<Evidence> getParticularEvidence(int caseNumber, String type) {
        ...
        return evidencebox.getEvidenceByType(type);
    }
